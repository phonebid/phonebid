...
interface DefaultDeliveryAddressCardProps {
  address: DeliveryAddressResponseDto;
}

const DefaultDeliveryAddressCard = ({ address }: DefaultDeliveryAddressCardProps) => {
  return (
...
export default DefaultDeliveryAddressCard;
